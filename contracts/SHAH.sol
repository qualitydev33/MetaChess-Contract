...
contract MetaChess is ERC20, Ownable {
    ...
    uint256 private constant gasPriceLimit = 560 * 1; // do not allow over x gwei for launch
//    uint256 private constant gasPriceLimit = 560 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() ERC20("MetaChess", "SHAH") {
        address newOwner = 0x764425cA8b170e7E017Ee4C8cCCA2DE5D88E717d;
